...
- Dibuat **varian responsif** untuk hampir semua gambar (contoh: `-480.webp`, `-800.webp`, `-1200.webp`) dan ditambahkan `srcset` + `sizes` pada tag `<img>`.
- Referensi gambar di HTML/CSS/JS/JSON sudah diubah ke `.webp`.
