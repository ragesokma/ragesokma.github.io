...
<article class="popular-item">
  ...
  function mountIndex(posts) {
    ...
    // Tampilkan 6 berita (desktop 2 baris x 3). Mobile: standar kebawah (tanpa horizontal scroll).
    const berita = beritaAll.slice(0, 6);
    ...
    root.innerHTML = `
      <div id="beritaPanel" class="lg:col-span-3 lg:block">
        <div class="posts-grid" id="homeNewsCards">
          ${berita.map(renderCard).join("")}
        </div>
      </div>
